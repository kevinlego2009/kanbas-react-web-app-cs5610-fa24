...
export default function QuizDetailEditor() {
  ...
  const saveQuiz = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    console.log("Quiz data being sent:", quiz); // Debugging log
    ...
    <div className="container mt-5">
      ...
      <form>
        ...
        <div className="row mb-3">
          <div className="col-md-10 offset-md-2">
            ...
            <div className="form-check mb-2 d-flex align-items-center">
              ...
              />
              <label htmlFor="timeLimit" className="form-check-label me-2">
                Time Limit
              </label>
              <input
                type="number"
        ...
        <div className="d-flex justify-content-end">
          ...
          <button className="btn btn-danger" onClick={(e) => saveQuiz(e)}>
            Save
          </button>
        </div>
      </form>
